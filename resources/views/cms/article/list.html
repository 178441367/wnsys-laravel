...
<link rel="stylesheet" href="<?php echo URL::asset('assets/css/info-mgt.css');?>" />
<link rel="stylesheet" href="<?php echo URL::asset('assets/css/WdatePicker.css');?>" />
...
<script type="text/javascript" src="<?php echo URL::asset('assets/js/jquery.pagination.js');?>"></script>
